...
import { Grid3x3, ShoppingBasket, Zap, Bus, PiggyBank, ArrowRight, ThumbsUp, MessageCircle, Lightbulb, Refrigerator, Sun, Lock, X } from "lucide-react"
        ...
        <div className="relative rounded-3xl overflow-hidden mb-12 bg-[#1C3FA8] p-8 md:p-12 shadow-xl">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <button 
              ...
              className="bg-[#E53935] text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:scale-105 active:scale-95 transition-all"
            >
              Submit a Tip
            </button>
          </div>
